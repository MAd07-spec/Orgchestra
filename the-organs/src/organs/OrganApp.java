...
public class OrganApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        // -------- BODY IMAGE --------
        var bodyUrl = getClass().getResource("/organs/resources/body.png");
        if (bodyUrl == null) {
            System.err.println("ERROR: body.png not found. Make sure it is in src/organs/resources and on the classpath.");
        }
        ImageView bodyView = new ImageView(new Image(bodyUrl.toExternalForm()));
